...
<head>
    ...
    <link rel="stylesheet" href="style3vip.css">
...
<header>
    <header>
        ...
        <nav>
            <ul class="menuenlace">
                ...
                <li><a href="#ubicacion" style="font-size: 2em;">Ubicación</a></li>
    ...
    <main>
        <section id="inicio">
            <h2>Bienvenido a Pollería Diaz</h2>
        ...
        <section id="menu">
            ...
            <img src="https://polleriaslagranja.com/wp-content/uploads/2022/10/La-Granja-Real-Food-Chicken-1-Pollo-a-la-Brasa.png" alt="plato1"width="300" class="tamañopollo">       <img src="https://polleriaslagranja.com/wp-content/uploads/2022/10/La-Granja-Real-Food-Chicken-Promo-Delivery-1.png" alt="plato2"width="300" class="tamañopollo">       <img src="https://polleriaslagranja.com/wp-content/uploads/2022/10/La-Granja-Real-Food-Chicken-1.2-Pollo-a-la-Brasa.png" alt="plato3"width="300" class="tamañopollo"><br></br>
            </div>
